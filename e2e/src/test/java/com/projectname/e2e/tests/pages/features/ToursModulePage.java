...
public class ToursModulePage extends PageBase {
    public ToursModulePage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()){
            ...
            if (navigationBarPage.isDisplayed()){
                navigationBarPage.openToursModulePage();
            }
        }
        return this;
    }
