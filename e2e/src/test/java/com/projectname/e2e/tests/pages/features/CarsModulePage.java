...
public class CarsModulePage extends PageBase {
    public CarsModulePage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()){
            ...
            if (navigationBarPage.isDisplayed()){
                navigationBarPage.openCarsModulePage();
            }
        }
        return this;
    }
