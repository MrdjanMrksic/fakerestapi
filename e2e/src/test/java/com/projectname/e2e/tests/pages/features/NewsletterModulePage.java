...
public class NewsletterModulePage extends PageBase {
    public NewsletterModulePage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()){
            ...
            if (navigationBarPage.isDisplayed()){
                navigationBarPage.openNewsletterModulePage();
            }
        }
        return this;
    }
