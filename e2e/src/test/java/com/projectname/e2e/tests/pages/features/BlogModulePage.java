...
public class BlogModulePage extends PageBase {
    public BlogModulePage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()){
            ...
            if (navigationBarPage.isDisplayed()){
                navigationBarPage.openBlogModulePage();
            }
        }
        return this;
    }
