...
public class OffersModulePage extends PageBase {
    public OffersModulePage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()){
            ...
            if (navigationBarPage.isDisplayed()){
                navigationBarPage.openOffersModulePage();
            }
        }
        return this;
    }
