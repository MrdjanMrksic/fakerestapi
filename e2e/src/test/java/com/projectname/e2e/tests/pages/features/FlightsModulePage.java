...
public class FlightsModulePage extends PageBase {
    public FlightsModulePage(CustomWebDriver driver, String url, String email, String password) {
    ...
    public PageBase show() {
        if(!isDisplayed()){
            ...
            if (navigationBarPage.isDisplayed()){
                navigationBarPage.openFlightsModulePage();
            }
        }
        return this;
    }
